package com.fcfruit.zombiesmash.release.powerups.gun_powerup;
...
import com.fcfruit.zombiesmash.release.entity.DrawableGraphicsEntity;
...
public class PistolPowerup extends GunPowerup
{
    ...
    public void activate()
    {
        ...
        {
            DrawableGraphicsEntity tempGun = new DrawableGraphicsEntity(new Sprite(new Texture(Gdx.files.internal("powerups/gun/pistol/pistol.png"))));
