...
import com.fcfruit.zombiesmash.release.entity.AnimatableGraphicsEntity;
import com.fcfruit.zombiesmash.release.entity.ContainerEntity;
import com.fcfruit.zombiesmash.release.entity.InteractiveGraphicsEntity;
import com.fcfruit.zombiesmash.release.entity.MovableEntity;
import com.fcfruit.zombiesmash.release.entity.MultiGroundEntity;
import com.fcfruit.zombiesmash.release.entity.OptimizableEntity;
...
import com.fcfruit.zombiesmash.release.rube.loader.RubeSceneLoader;
        ...
        AnimatableEntityInterface, MovableEntityInterface, MultiGroundEntityInterface
{
    ...
    protected void createPart(Body physicsBody, String bodyName, Sprite sprite, ArrayList<Joint> joints, ContainerEntityInterface containerEntity)
    {
        ...
        if (joints.size() > 0)
        {
            com.fcfruit.zombiesmash.release.zombies.NewPart part = new com.fcfruit.zombiesmash.release.zombies.NewPart(bodyName, sprite, physicsBody, joints, containerEntity);
    ...
    private void handleGetup()
    {
        if (!this.isAnimating() && !this.isGettingUp && this.hasRequiredPartsForGetup() && System.currentTimeMillis() - getUpTimer >= timeBeforeGetup)
        {
            ...
            mouseJointDef.bodyB = ((com.fcfruit.zombiesmash.release.zombies.NewPart) this.getInteractiveEntities().get("head")).getPhysicsBody();
