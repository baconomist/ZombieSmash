package com.fcfruit.zombiesmash.rube;
...
public class RubeScene 
{
	...
	private Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> mImages;
	private Map<Body,Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage>> mBodyImageMap;
	...
	public RubeScene()
	{
		...
		mBodyImageMap = new HashMap<Body,Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage>>();
   ...
   public void setImages(Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> images)
   {
      mImages = images;
   }
   
   public Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> getImages()
   {
      return mImages;
   }
   
   public void setMappedImage(Body body, com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage image)
   {
      Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> images = mBodyImageMap.get(body);
      // if the mapping hasn't been created yet...
      if (images == null)
      {
         // initialize the key's value...
         images = new Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage>(false,1); // expectation is that most, if not all, bodies will have a single image.
         images.add(image);
   ...
   public Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> getMappedImage(Body body)
   {
