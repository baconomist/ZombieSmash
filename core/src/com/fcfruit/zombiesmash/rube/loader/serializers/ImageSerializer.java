package com.fcfruit.zombiesmash.rube.loader.serializers;
...
public class ImageSerializer extends ReadOnlySerializer<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage>
{
   ...
   @Override
   public com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage read(Json json, JsonValue jsonData, Class type)
   {
      // Images reference bodies based on indexing in the .json file. -1 means no body reference
      Array<Body> bodies = scene.getBodies();
      
      com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage defaults = com.fcfruit.zombiesmash.rube.RubeDefaults.Image.image;
      
      com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage image = new com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage();
      ...
      com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeVertexArray corners = json.readValue("corners", com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeVertexArray.class, jsonData);
      if(corners != null)
      {
      ...
      int [] colorArray = json.readValue("colorTint", int[].class, com.fcfruit.zombiesmash.rube.RubeDefaults.Image.colorArray,jsonData);
