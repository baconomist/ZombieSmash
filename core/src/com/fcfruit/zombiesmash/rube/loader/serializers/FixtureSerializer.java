...
public class FixtureSerializer extends ReadOnlySerializer<Fixture>
{
	...
	{	
		...
		{
			com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeVertexArray vertices = json.readValue("vertices", com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeVertexArray.class, jsonData);
