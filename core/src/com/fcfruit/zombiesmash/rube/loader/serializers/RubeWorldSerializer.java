...
public class RubeWorldSerializer extends ReadOnlySerializer<RubeScene>
{
	...
	public RubeScene read(Json json, JsonValue jsonData, Class type)
	{
	   if (!mScenePopulated)
	   {
	      scene.stepsPerSecond 		= json.readValue("stepsPerSecond", 		int.class, com.fcfruit.zombiesmash.rube.RubeDefaults.World.stepsPerSecond, 		jsonData);
	      scene.positionIterations 	= json.readValue("positionIterations", 	int.class, com.fcfruit.zombiesmash.rube.RubeDefaults.World.positionIterations, 	jsonData);
	      scene.velocityIterations 	= json.readValue("velocityIterations", 	int.class, com.fcfruit.zombiesmash.rube.RubeDefaults.World.velocityIterations, 	jsonData);
