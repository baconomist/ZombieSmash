...
public class WorldSerializer extends ReadOnlySerializer<World>
{
	...
	private final com.fcfruit.zombiesmash.rube.loader.serializers.JointSerializer jointSerializer;
	private final com.fcfruit.zombiesmash.rube.loader.serializers.ImageSerializer imageSerializer;
	...
	public WorldSerializer(RubeScene scene, Json _json)
	{
		...
		jointSerializer = new com.fcfruit.zombiesmash.rube.loader.serializers.JointSerializer(scene,_json);
		_json.setSerializer(Joint.class, jointSerializer);
		
		imageSerializer = new com.fcfruit.zombiesmash.rube.loader.serializers.ImageSerializer(scene);
		_json.setSerializer(com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage.class, imageSerializer);
	}
	...
	public World read(Json json, JsonValue jsonData, Class type) 
	{
	   ...
	   if (world == null)
	   {
		...
		// Images
		Array<com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage> images = json.readValue("image", Array.class, com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage.class, jsonData);
		if (images != null)
		{
		   ...
		   {
		      com.fcfruit.zombiesmash.rube.loader.serializers.utils.RubeImage image = images.get(i);
