...
public class Torso implements DrawableEntityInterface, OptimizableEntityInterface, InteractivePhysicsEntityInterface, com.fcfruit.zombiesmash.entity.interfaces.NameableEntityInterface
{
    private String name;
