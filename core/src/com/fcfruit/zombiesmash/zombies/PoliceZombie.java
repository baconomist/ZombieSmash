            ...
            */
            ...
            for (RubeImage i : rubeScene.getImages()) {
                if (i.body == b) {
                    ...
                    sprite.setSize(i.width*Physics.PIXELS_PER_METER*skeleton.getData().findBone(bodyName).getScaleX(), i.height*Physics.PIXELS_PER_METER*skeleton.getData().findBone(bodyName).getScaleY());
                    sprite.setOriginCenter();
