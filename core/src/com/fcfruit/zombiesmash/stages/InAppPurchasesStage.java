...
public class InAppPurchasesStage extends RubeStage
{
    ...
    public InAppPurchasesStage(Viewport viewport)
    {
        ...
        this.productButton = (ImageButton) this.findActor("product_button");
        ...
        this.leftButton = (ImageButton) this.findActor("left_button");
        this.rightButton = (ImageButton) this.findActor("right_button");
