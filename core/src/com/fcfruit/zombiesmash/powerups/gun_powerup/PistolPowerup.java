...
public class PistolPowerup extends GunPowerup
{
    ...
    {
        super(new Sprite(new Texture(Gdx.files.internal("powerups/gun/pistol/pistol_ui.png"))));
    }
    ...
    public void activate()
    {
        ...
        {
            com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity tempGun = new com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity(new Sprite(new Texture(Gdx.files.internal("powerups/gun/pistol/pistol.png"))));
        ...
        {
            com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity tempGun_left = new com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity(new Sprite(new Texture(Gdx.files.internal("powerups/gun/pistol/pistol.png"))));
            tempGun_left.setPosition(new Vector2(7, 3));
            tempGun_left.getSprite().setFlip(true, false);

            com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity tempGun_right = new com.fcfruit.zombiesmash.entity.DrawableGraphicsEntity(new Sprite(new Texture(Gdx.files.internal("powerups/gun/pistol/pistol.png"))));
