...
public class NightLevelSurvival extends SurvivalLevel
{

    private com.fcfruit.monstersmash.entity.AnimatableGraphicsEntity clouds;

    public NightLevelSurvival(int level_id)
    {

        super(level_id, "maps/night_map/levels/"+level_id+".json");
        ...
        this.clouds = new com.fcfruit.monstersmash.entity.AnimatableGraphicsEntity(skeleton, state, atlas);
