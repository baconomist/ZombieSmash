...
public class Physics
{
    ...
    public void update(float delta)
    {
        ...
        for (com.fcfruit.monstersmash.entity.interfaces.DetachableEntityInterface detachableEntityInterface : Environment.detachableEntityDetachQueue)
        {
        ...
        for (com.fcfruit.monstersmash.entity.interfaces.ExplodableEntityInterface explodableEntityInterface : Environment.explodableEntityQueue)
        {
