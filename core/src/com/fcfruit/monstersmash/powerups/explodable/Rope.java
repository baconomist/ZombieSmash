...
public class Rope
{
    ...
    private com.fcfruit.monstersmash.entity.DrawablePhysicsEntity[] drawablePhysicsEntities;
    ...
    public Rope(int length, Vector2 position)
    {
        ...
        this.drawablePhysicsEntities = new com.fcfruit.monstersmash.entity.DrawablePhysicsEntity[length];
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            this.drawablePhysicsEntities[i] = new com.fcfruit.monstersmash.entity.DrawablePhysicsEntity(new Sprite(new Texture(Gdx.files.internal("powerups/explodable/chain/chain"+(new Random().nextInt(4)+1)+".png"))), this.segments[i]);
