...
import com.fcfruit.monstersmash.entity.AnimatablePhysicsEntity;
...
public class BrainCrate implements AnimatableEntityInterface, InteractiveEntityInterface
{
    ...
    private com.fcfruit.monstersmash.entity.AnimatablePhysicsEntity animatablePhysicsEntity;
    ...
    public BrainCrate(float posx)
    {
        ...
        this.animatablePhysicsEntity = new com.fcfruit.monstersmash.entity.AnimatablePhysicsEntity(skeleton, state, atlas, Environment.physics.createBody(bodyDef));
        ...
        this.interactiveGraphicsEntity = new com.fcfruit.monstersmash.entity.InteractiveGraphicsEntity(this.animatablePhysicsEntity, polygon);
