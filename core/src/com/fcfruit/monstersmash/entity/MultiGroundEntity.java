...
public class MultiGroundEntity implements MultiGroundEntityInterface
{
    ...
    private com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface drawableEntity;

    public MultiGroundEntity(com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface drawableEntity, MovableEntityInterface movableEntity)
    {
