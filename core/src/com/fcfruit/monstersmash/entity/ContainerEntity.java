...
{
    private HashMap<String, com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface> drawableEntities;
    ...
    {
        this.drawableEntities = new HashMap<String, com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface>();
    ...
    @Override
    public HashMap<String, com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface> getDrawableEntities()
    {
    ...
    @Override
    public void setDrawableEntities(HashMap<String, com.fcfruit.monstersmash.entity.interfaces.DrawableEntityInterface> drawableEntities)
    {
