...
public class ExplodableEntity implements ExplodableEntityInterface, com.fcfruit.monstersmash.entity.interfaces.AnimatableEntityInterface
{
    ...
    public ExplodableEntity(com.fcfruit.monstersmash.entity.interfaces.PhysicsEntityInterface physicsEntityInterface, float explosionForce)
    {
    ...
    public void explode()
    {
        ...
        for (int i = 0; i < numRays; i++)
        {
            ...
            this.particles.add(particle); // load the particle
        }
