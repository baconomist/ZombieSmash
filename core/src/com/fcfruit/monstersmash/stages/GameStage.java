...
public class GameStage extends Stage
{
    ...
    public void draw()
    {
        ...
        if(com.fcfruit.monstersmash.Config.DEBUG_POLYGONS)
        {
    ...
    {
        Environment.touchedDownItems = new ArrayList<com.fcfruit.monstersmash.entity.interfaces.InputCaptureEntityInterface>();
