...
import com.fcfruit.monstersmash.rube.loader.serializers.FixtureSerializer;
import com.fcfruit.monstersmash.rube.loader.serializers.Vector2Serializer;

public class BodySerializer extends ReadOnlySerializer<Body>
{
	private 	  World world;
	private final BodyDef def = new BodyDef();
	private final com.fcfruit.monstersmash.rube.loader.serializers.FixtureSerializer fixtureSerializer;
	...
	public Body read(Json json, JsonValue jsonData, Class type) 
	{
		if(world == null)
			return null;
		BodyDef defaults = com.fcfruit.monstersmash.rube.RubeDefaults.Body.definition;
