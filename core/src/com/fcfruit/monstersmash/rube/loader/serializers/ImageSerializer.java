...
import com.fcfruit.monstersmash.rube.loader.serializers.utils.RubeVertexArray;
...
public class ImageSerializer extends ReadOnlySerializer<RubeImage>
{
   ...
   public RubeImage read(Json json, JsonValue jsonData, Class type)
   {
      ...
      RubeImage defaults = com.fcfruit.monstersmash.rube.RubeDefaults.Image.image;
      ...
      int [] colorArray = json.readValue("colorTint", int[].class, com.fcfruit.monstersmash.rube.RubeDefaults.Image.colorArray,jsonData);
