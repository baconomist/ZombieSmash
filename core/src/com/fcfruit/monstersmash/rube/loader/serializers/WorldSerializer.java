package com.fcfruit.monstersmash.rube.loader.serializers;
...
import com.fcfruit.monstersmash.rube.RubeDefaults;
import com.fcfruit.monstersmash.rube.RubeScene;
import com.fcfruit.monstersmash.rube.loader.serializers.BodySerializer;

public class WorldSerializer extends ReadOnlySerializer<World>
{
	private final com.fcfruit.monstersmash.rube.loader.serializers.BodySerializer bodySerializer;
	private final com.fcfruit.monstersmash.rube.loader.serializers.JointSerializer jointSerializer;
	private final com.fcfruit.monstersmash.rube.loader.serializers.ImageSerializer imageSerializer;
	...
	public WorldSerializer(RubeScene scene, Json _json)
	{
		...
		jointSerializer = new com.fcfruit.monstersmash.rube.loader.serializers.JointSerializer(scene,_json);
		_json.setSerializer(Joint.class, jointSerializer);
		
		imageSerializer = new com.fcfruit.monstersmash.rube.loader.serializers.ImageSerializer(scene);
