package com.fcfruit.monstersmash.rube.loader;

import com.badlogic.gdx.files.FileHandle;
import com.badlogic.gdx.physics.box2d.World;
import com.badlogic.gdx.utils.Json;
import com.badlogic.gdx.utils.SerializationException;
import com.fcfruit.monstersmash.rube.loader.serializers.RubeWorldSerializer;
...
public class RubeSceneLoader
{
   ...
   private final com.fcfruit.monstersmash.rube.loader.serializers.RubeWorldSerializer mRubeWorldSerializer;
   ...
   public RubeSceneLoader(World world, Json gameJson)
   {
      ...
      json.setSerializer(RubeScene.class, mRubeWorldSerializer = new com.fcfruit.monstersmash.rube.loader.serializers.RubeWorldSerializer(json));
      mWorld = world;
   }
