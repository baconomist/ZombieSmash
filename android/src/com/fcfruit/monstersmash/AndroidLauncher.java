...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		com.fcfruit.monstersmash.Environment.purchaseManager = new AndroidGooglePlayPurchaseManager(this, 0);
		initialize(com.fcfruit.monstersmash.Environment.game, config);
	}
